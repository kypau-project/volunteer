<div>
    ...
    <div class="d-flex justify-content-end align-items-center mb-3">
        <a href="{{ route('coordinator.events.create') }}" wire:navigate class="btn btn-primary">
                                ...
                                <tr>
                                    ...
                                    <td class="text-center">
                                        <div class="btn-group" role="group">
                                            <a href="{{ route('coordinator.events.edit', $event) }}" wire:navigate class="btn btn-warning btn-sm">
                                                <i class="bi-pencil"></i> Edit
                                            </a>
                                            <a href="{{ route('coordinator.events.attendance', $event) }}" wire:navigate class="btn btn-info btn-sm">
                                                <i class="bi-calendar-check"></i> Absensi
                                            </a>

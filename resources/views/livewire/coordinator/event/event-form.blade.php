                        ...
                        <div class="form-body">
                            <div class="row">
                                        ...
                                        <div class="position-relative">
                                            ...
                                            <div class="mt-2">
                                                ...
                                                <span class="badge bg-light-primary me-1 mb-1">
                                                    {{ $skill }}
                                                    <i class="bi bi-x-circle cursor-pointer" wire:click="removeRequiredSkill('{{ $skill }}')"></i>
                                                </span>
                                                @endforeach
                                            </div>
                                ...
                                <div class="col-12 d-flex justify-content-end">
                                    ...
                                    <a href="{{ route('coordinator.events.index') }}" class="btn btn-light-secondary me-1 mb-1">

...
class EventForm extends Component
{
    ...
    public $location;
    public $quota;
    public $required_skills; // legacy comma-separated string (kept for backwards compat)
    public $required_skills_list = []; // array for interactive tag UI
    ...
    public function save()
    {
        ...
        // Prefer interactive list if present, otherwise convert comma-separated string back to array for storage
        $skillsArray = !empty($this->required_skills_list) ? $this->required_skills_list : array_filter(array_map('trim', explode(',', $this->required_skills)));
    ...
    // Helper to build Google Maps search URL from location when maps_url not provided
